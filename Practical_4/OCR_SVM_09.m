...
sampling=15; % in order to get an accuracy that actually changes when the variables are chagned I changed the samplling from 50 to 15
...
for i=1:size(images,1)
    ...
    %Takes a while to train but accuracy is .9050
